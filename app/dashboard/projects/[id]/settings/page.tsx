...
export default function ProjectSettingsPage() {
  ...
  const fontOptions: VisualChoiceOption<EventGalleryBrandingSettings["fontPreset"]>[] = [
    {
      value: "brandon",
      label: "Brandon",
      description: "Crisp premium sans for modern event galleries.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Avenir_Next","Helvetica_Neue",Helvetica,Arial,sans-serif]'>Brandon</div>,
    },
    {
      value: "freeland",
      label: "Freeland",
      description: "A softer handwritten accent for celebratory moments.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Brush_Script_MT","Segoe_Script",cursive]'>Freeland</div>,
    },
    {
      value: "baskerville",
      label: "Baskerville",
      description: "Elegant serif styling with a classic editorial feel.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:Baskerville,"Baskerville_Old_Face",Garamond,serif]'>Baskerville</div>,
    },
    {
      value: "playfair",
      label: "Playfair",
      description: "Refined contrast for weddings and portrait-heavy events.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Palatino_Linotype",Palatino,Georgia,serif]'>Playfair</div>,
    },
    {
      value: "studio-sans",
      label: "Studio Sans",
      description: "Modern and simple for most events.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[22px] text-neutral-600 [font-family:"Helvetica_Neue",Helvetica,Arial,sans-serif]'>Studio</div>,
    },
    {
      value: "editorial-serif",
      label: "Editorial Serif",
      description: "A softer luxury look for weddings and portraits.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-600 [font-family:Georgia,"Times_New_Roman",serif]'>Atelier</div>,
    },
    {
      value: "classic-contrast",
      label: "Classic Contrast",
      description: "Clean premium feel with stronger contrast.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[22px] uppercase tracking-[0.16em] text-neutral-600 [font-family:"Avenir_Next","Helvetica_Neue",Helvetica,Arial,sans-serif]'>Gallery</div>,
    },
    {
      value: "spectral",
      label: "Spectral",
      description: "Bookish serif mood with a softer hierarchy.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:Cambria,Georgia,serif]'>Spectral</div>,
    },
    {
      value: "montserrat",
      label: "Montserrat",
      description: "Geometric and structured for a sharper wall layout.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Helvetica_Neue",Arial,sans-serif]'>Montserrat</div>,
    },
    {
      value: "raleway",
      label: "Raleway",
      description: "Light and airy for fashion and detail-focused events.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Trebuchet_MS",Arial,sans-serif]'>Raleway</div>,
    },
    {
      value: "inter",
      label: "Inter",
      description: "Quiet, flexible, and polished for everyday galleries.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:Inter,system-ui,sans-serif]'>Inter</div>,
    },
    {
      value: "quicksand",
      label: "Quicksand",
      description: "Rounded tone for family and youth-forward events.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Trebuchet_MS","Century_Gothic",Arial,sans-serif]'>Quicksand</div>,
    },
    {
      value: "oswald",
      label: "Oswald",
      description: "Tall headline styling for a bolder graphic look.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] uppercase tracking-[0.12em] text-neutral-700 [font-family:Impact,Haettenschweiler,"Arial_Narrow_Bold",sans-serif]'>Oswald</div>,
    },
    {
      value: "pt-sans",
      label: "PT Sans",
      description: "Calm, readable sans with a classic utility feel.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:"Gill_Sans","Segoe_UI",Arial,sans-serif]'>PT Sans</div>,
    },
    {
      value: "lato",
      label: "Lato",
      description: "Friendly neutral sans for broad client audiences.",
      preview: <div className='flex h-24 items-center justify-center bg-neutral-50 text-[24px] text-neutral-700 [font-family:Verdana,"Trebuchet_MS",Arial,sans-serif]'>Lato</div>,
    },
  ];
