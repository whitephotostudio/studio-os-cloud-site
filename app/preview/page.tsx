        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-6">
          ...
          <section className="space-y-6">
            <div className="rounded-[24px] border border-neutral-200 bg-white px-5 py-4 shadow-sm">
              ...
              <div className="text-xs text-neutral-500">A clearer look at the photographer experience</div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {[
                ...
                <div key={label} className="rounded-[24px] border border-neutral-200 bg-white p-5 shadow-sm">
            ...
            <div className="grid xl:grid-cols-[1.1fr_0.9fr] gap-6">
              <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-neutral-500 mt-1">A cleaner production pipeline for cloud-connected jobs</p>
                  </div>
                ...
                <div className="mt-5 space-y-3">
                  {orders.map((order) => (
                    <div key={order.school + order.type} className="rounded-2xl border border-neutral-200 p-4">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="text-right">
                          <div className="text-lg font-semibold text-neutral-950">{order.count}</div>
              ...
              <div className="space-y-6">
                <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm">
                  <h2 className="text-lg font-semibold text-neutral-950">Photographer onboarding</h2>
                  <p className="mt-1 text-sm text-neutral-500">How new studios enter the ecosystem</p>
                  <div className="mt-5 space-y-3">
                    {[
                ...
                <div className="rounded-[28px] border border-neutral-200 bg-gradient-to-br from-black to-neutral-800 text-white p-6 shadow-xl">
                  ...
                  <div className="mt-2 text-2xl font-semibold tracking-tight">AI retouch and smart production tools</div>
                  <p className="mt-3 text-sm text-neutral-300 leading-7">
                    Space for premium add-ons like retouch credits, background tools, advanced gallery customization, and deeper cloud-to-production syncing.
                  </p>
                </div>
              </div>
            </div>
