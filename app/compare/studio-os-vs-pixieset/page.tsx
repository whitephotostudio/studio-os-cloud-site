...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.studiooscloud.com/compare/studio-os-vs-pixieset" },
  openGraph: {
    ...
    url: "https://www.studiooscloud.com/compare/studio-os-vs-pixieset",
  },
};
...
export default function StudioOsVsPixieset() {
  return (
    <ComparisonPage
      ...
      competitorSlug="pixieset"
      competitorUrl="https://pixieset.com"
      alternativePagePath="/pixieset-alternative"
